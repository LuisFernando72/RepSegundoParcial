...
public class Control extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Tabledos = new javax.swing.JTable();
        ...
        jScrollPane1.setBounds(30, 290, 340, 410);
        ...
        jScrollPane2.setBounds(420, 520, 530, 170);

        Tabledos.setBackground(new java.awt.Color(204, 255, 255));
        Tabledos.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true));
        Tabledos.setFont(new java.awt.Font("Dialog", 3, 14)); // NOI18N
        Tabledos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane3.setViewportView(Tabledos);

        jPanel1.add(jScrollPane3);
        jScrollPane3.setBounds(420, 330, 520, 180);
    ...
    public void eliminar() {
        DefaultTableModel tb = (DefaultTableModel) Tabledos.getModel();
        int a = Tabledos.getRowCount() - 1;
        for (int i = a; i >= 0; i--) {
    ...
    private void btnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarActionPerformed
        ...
        int i = -1, dos = 0; //Contador

        DefaultTableModel tabla = new DefaultTableModel();
        String encabezado[] = {"No", "Clave", "Token"};
        ...
        for (String s : splitString) {
            ...
            while (token.hasMoreElements()) {
                ...
                while (token2.hasMoreElements()) {
                    ...
                    //    Areajash.append("\n|" + String.valueOf(i) + String.valueOf(s.indexOf(elemento2.toString())) + "\t|" + elemento2);
                    datos[0] = String.valueOf(dos);
                    datos[1] = String.valueOf(i) + String.valueOf(s.indexOf(elemento2.toString()));
                    datos[2] = (String) elemento2;
                    tabla.addRow(datos);
                    Tabledos.setModel(tabla);
    ...
    private javax.swing.JTable Tabledos;
